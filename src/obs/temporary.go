...
func (obsClient ObsClient) CreateBrowserBasedSignature(input *CreateBrowserBasedSignatureInput) (output *CreateBrowserBasedSignatureOutput, err error) {
	...
	ak := sh.AK
	sk := sh.SK
	token := sh.SecurityToken

	credential, _ := getCredential(ak, obsClient.conf.region, shortDate)
	...
	if token != "" {
		params[HEADER_STS_TOKEN_AMZ] = token
	}
	...
	policy := Base64Encode(StringToBytes(originPolicy))
	signature := getSignature(policy, sk, obsClient.conf.region, shortDate)
...
func (obsClient ObsClient) CreateBucketWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("CreateBucket", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketStoragePolicyWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketStoragePolicy", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketQuotaWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketQuota", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketAclWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketAcl", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketPolicyWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketPolicy", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketCorsWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketCors", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketVersioningWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketVersioning", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketWebsiteConfigurationWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketWebsiteConfiguration", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketLoggingConfigurationWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketLoggingConfiguration", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketLifecycleConfigurationWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketLifecycleConfiguration", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketTaggingWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketTagging", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetBucketNotificationWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetBucketNotification", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) SetObjectAclWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("SetObjectAcl", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) RestoreObjectWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *BaseModel, err error) {
	output = &BaseModel{}
	err = obsClient.doHttpWithSignedUrlInternal("RestoreObject", HTTP_POST, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	}
	return
...
func (obsClient ObsClient) PutObjectWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *PutObjectOutput, err error) {
	...
	err = obsClient.doHttpWithSignedUrlInternal("PutObject", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	} else {
...
func (obsClient ObsClient) PutFileWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, sourceFile string) (output *PutObjectOutput, err error) {
	...
	if sourceFile != "" {
		...
		if contentLength > stat.Size() {
			err = errors.New("ContentLength is larger than fileSize")
			return
		}
...
func (obsClient ObsClient) UploadPartWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *UploadPartOutput, err error) {
	...
	err = obsClient.doHttpWithSignedUrlInternal("UploadPart", HTTP_PUT, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	} else {
...
func (obsClient ObsClient) CompleteMultipartUploadWithSignedUrl(signedUrl string, actualSignedRequestHeaders http.Header, data io.Reader) (output *CompleteMultipartUploadOutput, err error) {
	...
	err = obsClient.doHttpWithSignedUrlInternal("CompleteMultipartUpload", HTTP_POST, signedUrl, actualSignedRequestHeaders, data, output, true, obsClient.isRepeatable(data))
	if err != nil {
		output = nil
	} else {
